...
class AddTanhLPNorm : public OpInterface {
private:
  ...
  uint64_t AddTanhLPNorm_id_;
  static uint64_t AddTanhLPNorm_count;
  /* debug flag */
  bool debug_ = false;
  std::string a_dtype_;
  std::string b_dtype_;
...
public:
  AddTanhLPNorm(const std::string &a_dtype, const std::string &b_dtype,
