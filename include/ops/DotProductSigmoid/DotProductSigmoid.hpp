...
class DotProductSigmoid : public OpInterface {
private:
  ...
  uint64_t DotProductSigmoid_id_;
  static uint64_t DotProductSigmoid_count;
  /* debug flag */
  bool debug_ = false;
  std::string a_dtype_;
  std::string b_dtype_;
...
public:
  DotProductSigmoid(const std::string &a_dtype, const std::string &b_dtype,
