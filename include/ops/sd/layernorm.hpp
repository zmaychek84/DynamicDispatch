...
private:
  ...
  uint64_t layernorm_id_;
  static uint64_t layernorm_count;
  /* debug flag */
  bool debug_ = false;
  std::string a_dtype_;
  std::string b_dtype_;
  std::string c_dtype_;
  const std::string sd_lrn_key_ = "sd_layernorm_";
...
public:
  layernorm(const std::string &a_dtype, const std::string &b_dtype,
