...
class softmax_qdq : public OpInterface {
private:
  ...
  uint64_t softmax_qdq_id_;
  static uint64_t softmax_qdq_count;
  /* debug flag */
  bool debug_ = false;
  std::string a_dtype_;
  std::string b_dtype_;
...
public:
  softmax_qdq(const std::string &a_dtype, const std::string &b_dtype,
