...
GetIfmTensor(const std::tuple<int, int, int, int, int, int, int, int, int, bool,
  ...
  size_t ifmSize;
  if ((zeroPoint == 29172) && (opModelNameLowerCase == "m3uec")) {
