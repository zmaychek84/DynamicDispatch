...
int test_softmax_qdq(int M, int N, bool debug = false,
  ...
  //       OpInterface::get_dd_base_dir() + fld_name + "//golden.bin";
...
// Softmax in mzdk54x4 has been integrated with QKT. More clean-up needs to be
// done.
// TEST(C4mzdk5_Softmax_Testa16w8, Kernel1) {
//  int err_count = test_softmax_qdq<int16_t, int16_t, uint16_t>(
//      256, 256, false, "uint16", "uint16", "uint16", "4x4mzdk5");
//  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
//}
//
// TEST(C4mzdk5_Softmax_Testa16w8, Kernel2) {
//  int err_count = test_softmax_qdq<int16_t, int16_t, uint16_t>(
//      1024, 1024, false, "uint16", "uint16", "uint16", "4x4mzdk5");
//  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
//}
//
// TEST(C4mzdk5_Softmax_Testa16w8, Kernel3) {
//  int err_count = test_softmax_qdq<int16_t, int16_t, uint16_t>(
//      4096, 4096, false, "uint16", "uint16", "uint16", "4x4mzdk5");
//  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
//}
