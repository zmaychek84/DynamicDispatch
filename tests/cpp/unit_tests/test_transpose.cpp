...
// TRANSPOSE
TEST(m3uec_TRANS_Testa16w8, Kernel1) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      1, 3136, 128, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}

TEST(m3uec_TRANS_Testa16w8, Kernel2) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      1, 784, 256, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}

TEST(m3uec_TRANS_Testa16w8, Kernel3) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      1, 196, 512, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}

TEST(m3uec_TRANS_Testa16w8, Kernel4) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      1, 49, 1024, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}

TEST(m3uec_TRANS_Testa16w8, Kernel5) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      64, 49, 128, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}

TEST(m3uec_TRANS_Testa16w8, Kernel6) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      16, 49, 256, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}

TEST(m3uec_TRANS_Testa16w8, Kernel7) {
  int err_count = test_transpose<uint16_t, int8_t, uint16_t>(
      4, 49, 512, false, "uint16", "int8", "uint16", "m3uec");
  EXPECT_TRUE(err_count == 0) << "Error Count = " << err_count;
}
